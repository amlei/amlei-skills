...
<style>
  ...
  body{background:var(--bg);color:var(--ink);font-family:var(--font-sans);font-size:13px;line-height:1.58;-webkit-font-smoothing:antialiased;font-feature-settings:'tnum' on;text-rendering:optimizeLegibility}
  ...
  .name-row .role{font-size:12.5px;font-weight:600;color:var(--accent-ink);background:var(--accent-soft);padding:3px 9px}
  ...
  .sec-head h2{font-size:12.5px;font-weight:700;letter-spacing:.16em;color:var(--ink)}
  ...
  .stack-row .cat{font-family:var(--font-mono);font-size:10px;color:var(--accent);padding-top:3px;letter-spacing:.04em}
  .chips{display:flex;flex-wrap:wrap;gap:4px}
  .chip{font-family:var(--font-mono);font-size:10.5px;color:var(--ink);border:1px solid var(--border);padding:1.5px 7px}
  ...
  .entry-title .org,.entry-title .proj{font-size:12.5px;font-weight:700}
  .entry-title .role{font-size:11.5px;color:var(--accent-ink);font-weight:500}
  .entry-title .badge{font-family:var(--font-mono);font-size:9.5px;color:var(--accent-ink);border:1px solid var(--accent);padding:1px 6px}
  .entry-date{font-family:var(--font-mono);font-size:10px;color:var(--faint);white-space:nowrap}
  .entry-meta{margin-top:2px;font-size:10.5px;color:var(--muted);display:flex;gap:12px;flex-wrap:wrap}
  .entry-meta b{color:var(--ink);font-weight:600}
  .entry-list{list-style:none;margin-top:4px}
  .entry-list li{position:relative;padding-left:13px;font-size:11px;line-height:1.68;color:var(--ink);margin-bottom:2px;text-align:justify;text-wrap:pretty}
  ...
  /* 论文 / 竞赛 */
  .pub{font-size:11px;line-height:1.55;padding:4px 0;border-bottom:1px dashed var(--hair)}
  .pub .ven{font-style:italic;color:var(--accent-ink)}
  .pub .yr{font-family:var(--font-mono);color:var(--faint);font-size:10px;margin-left:6px}
  .awards{display:grid;grid-template-columns:1fr 1fr;gap:2px 22px;margin-top:4px}
  .award{display:grid;grid-template-columns:54px 1fr auto;gap:7px;align-items:baseline;font-size:11px;padding:3px 0;border-bottom:1px dashed var(--hair)}
  .award .tag{font-family:var(--font-mono);font-size:9.5px;color:var(--accent)}
